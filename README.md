...
![Win时间机器（备份系统镜像）](./docs/Win时间机器（备份系统镜像）.png)
...
Win中安装微信。在桌面新建一个“微信多开-需要先关闭所有微信窗口.bat”的txt文件，输入如下内容（需要保证微信安装目录与下面路径匹配）。

> start C:\"Program Files (x86)"\Tencent\WeChat\WeChat.exe

具体操作和注意事项如图：

![Win微信多开](./docs/Win微信多开.png)
