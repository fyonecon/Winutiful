...
<img src="./docs/关闭中文输入法中的英文输入.png" alt="./docs/关闭中文输入法中的英文输入.png"  style="height:400px; max-width:100%;" />

更改默认输入法：

<img src="./docs/默认输入法.png" alt="./docs/默认输入法.png"  style="height:400px; max-width:100%;" />
...
<img src="./docs/Win11中打开Win10右键菜单.png" alt="./docs/Win11中打开Win10右键菜单.png"  style="height:400px; max-width:100%;" />
...
<img src="./docs/Win开始菜单优化.png" alt="./docs/Win开始菜单优化.png"  style="height:400px; max-width:100%;" />
...
<img src="./docs/Win触发角.png" alt="./docs/Win触发角.png"  style="height:400px; max-width:100%;" />
...
<img src="./docs/启动系统时打开上次未关闭的应用.png" alt="./docs/启动系统时打开上次未关闭的应用.png"  style="height:400px; max-width:100%;" />
...
<img src="./docs/网速显示.png" alt="./docs/网速显示.png"  style="height:400px; max-width:100%;" />
...
<img src="./docs/微软输入法导入自定义词库.png" alt="./docs/微软输入法导入自定义词库.png"  style="height:400px; max-width:100%;" />

### 将Win系统编码GBK设置成UTF-8（25H2+）：
【优化Win11】

关闭就是GBK（Win默认编码格式），打开就是UTF-8（推荐。Mac、Linux默认编码）。

<img src="./docs/Win默认UTF-8编码.png" alt="./docs/Win默认UTF-8编码.png"  style="height:400px; max-width:100%;" />

### Win11（25H2+）自带OCR图文识别：

Ctrl+Shift+s打开截图---截图完成后点击右下角的图片编辑---在图片编辑的上部菜单栏有OCR识别按钮，如下图：

<img src="./docs/win11-OCR.png" alt="./docs/win11-OCR.png"  style="height:400px; max-width:100%;" />

### Win11终端设置成“默认管理员模式”：
Win11终端设置成“默认管理员模式”，就不需要每次 Win+R 输入 cmd 后按 ctrl+shift+enter 进入管理员终端了。

位置：终端软件---设置---具体位置如图所示：

<img src="./docs/Win11终端设置成“默认管理员模式”.png" alt="./docs/Win11终端设置成“默认管理员模式”.png"  style="height:400px; max-width:100%;" />
...
<img src="./docs/Win时间机器（备份系统镜像）.png" alt="./docs/Win时间机器（备份系统镜像）.png"  style="height:400px; max-width:100%;" />

- （可选，系统盘安全可用的情况下）设置系统保护来还原文件历史或软件历史：设置-系统-关于-系统保护-配置或创建。

<img src="./docs/系统保护.png" alt="./docs/系统保护.png"  style="height:400px; max-width:100%;" />
...
<img src="./docs/Wechat-More.png" alt="./docs/Wechat-More.png"  style="height:400px; max-width:100%;" />
